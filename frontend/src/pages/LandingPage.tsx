...
export default function LandingPage(){
  ...
  return <main className="min-h-screen bg-panel px-5 py-10 text-ink sm:px-8 lg:py-14">
    <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
      ...
      <div className="mt-8 grid w-full max-w-4xl grid-cols-2 overflow-hidden rounded-lg border border-line bg-white shadow-soft sm:grid-cols-5">
        ...
        <Stat value={data?.authorizations ?? '—'} label="Authorizations"/>
        <Stat value={data ? data.prompt_tokens_used.toLocaleString() : '—'} label="Prompt tokens used" last/>
      </div>
